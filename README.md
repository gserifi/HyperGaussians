**This README is a minimally adpated version of the original one in the [GaussianHeadAvatar repository](https://github.com/YuelangX/Gaussian-Head-Avatar). Please report issues that are not related to HyperGaussians to the original repository.**

# HyperGaussians-GaussianHeadAvatar
